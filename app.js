// v.1.5 (896) – statistiky vedle sebe na mobilu a tvrdší AI line-containment bez zásahu do online her.
...
(async () => {
  ...
  try {
    if (window.__rakModuleReadinessRegistry) {
      window.__rakModuleReadinessRegistry.expected = ['module-readiness.js', 'rak-namespace.js', 'rak-audit-baseline.js', 'rak-runtime-health.js', 'rak-storage-sync-audit.js', 'rak-boot-sequence-audit.js', 'rak-export-release-audit.js', 'rak-dom-action-audit.js', 'rak-supabase-client-audit.js', 'app.js', 'data.js'].concat(files.slice());
...
function installPwaAndConnectivityHooks() {
  ...
  const pwaHardeningStatus = window.__rakPwaHardeningStatus || {
    ...
    pwaAssetAuditMode: 'zip-source-inventory-assets-pwa-sql-release-readiness-architecture-module-readiness-runtime-health-storage-sync-namespace-closed-export-manifest-preflight-dom-action-v896',

// v.1.5 (913) – release gating/checklist matice nad hotovými read-only audity bez zásahu do online flow.
...
function installPwaAndConnectivityHooks() {
  ...
  const pwaHardeningStatus = window.__rakPwaHardeningStatus || {
    ...
    pwaAssetAuditMode: 'zip-source-inventory-assets-pwa-sql-release-readiness-architecture-module-readiness-runtime-health-storage-sync-namespace-closed-export-manifest-preflight-appsec-gates-v913',

// v.1.5 (896) – module readiness registry včetně online game contract audit helperu.
...
(function setupRakModuleReadinessRegistry() {
  ...
  const registry = window.__rakModuleReadinessRegistry = {
    ...
    mode: 'module-readiness-registry-v896',
    startedAt: nowIso(),
    startedMs: nowMs(),
    expected: [],
    modules: {},
  ...
  window.getRakModuleReadinessHealth = function getRakModuleReadinessHealth(expectedOverride) {
    ...
    return {
      ...
      mode: registry.mode || 'module-readiness-registry-v896',

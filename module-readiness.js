// v.1.5 (893) – module readiness registry včetně Supabase client/queue audit helperu.
...
(function setupRakModuleReadinessRegistry() {
  ...
  const registry = window.__rakModuleReadinessRegistry = {
    ...
    mode: 'module-readiness-registry-v893',
    startedAt: nowIso(),
    startedMs: nowMs(),
    expected: [],
    modules: {},
  ...
  window.getRakModuleReadinessHealth = function getRakModuleReadinessHealth(expectedOverride) {
    ...
    return {
      ...
      mode: registry.mode || 'module-readiness-registry-v893',

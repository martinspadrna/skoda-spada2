// v.1.5 (895) – module readiness registry včetně online game contract audit helperu.
...
(function setupRakModuleReadinessRegistry() {
  ...
  const registry = window.__rakModuleReadinessRegistry = {
    ...
    mode: 'module-readiness-registry-v895',
    startedAt: nowIso(),
    startedMs: nowMs(),
    expected: [],
    modules: {},
  ...
  window.getRakModuleReadinessHealth = function getRakModuleReadinessHealth(expectedOverride) {
    ...
    return {
      ...
      mode: registry.mode || 'module-readiness-registry-v895',

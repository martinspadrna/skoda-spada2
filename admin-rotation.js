// RaK 1.2 (1.34) – Administrace Rozpisy a Nastavení strojů oddělené z hlavního UI modulu.
...
function adminShowRotationSelectedRemove(input) {
  try {
    ...
    // RaK 1.2 (1.34) – horní sticky tlačítko už při kliknutí do jména nevytahujeme.

// RaK 1.2 (1.70) – Administrace Rozpisy a Nastavení strojů oddělené z hlavního UI modulu.
...
function adminShowRotationSelectedRemove(input) {
  try {
    ...
    // RaK 1.2 (1.70) – horní sticky tlačítko už při kliknutí do jména nevytahujeme.

// v.1.6 (1008) – Administrace / Rozpisy a Nastavení strojů oddělené z hlavního UI modulu.
...
function adminShowRotationSelectedRemove(input) {
  try {
    ...
    // v.1.6 (1008): horní sticky tlačítko už při kliknutí do jména nevytahujeme.

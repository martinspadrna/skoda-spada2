// RaK 1.2 (1.144) – Administrace Rozpisy a Nastavení strojů oddělené z hlavního UI modulu.
...
function adminBuildRotationGenerationModel(targetMonthKey) {
  ...
  const replaySoftCoreHardAssignment = (machineName, name) => {
    ...
    // RaK 1.2 (1.144): návaznost Synka/Třasáka/Střížka se nesmí odvozovat jen z posledního dne
...
function adminShowRotationSelectedRemove(input) {
  try {
    ...
    // RaK 1.2 (1.144) – horní sticky tlačítko už při kliknutí do jména nevytahujeme.

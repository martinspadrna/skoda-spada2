-- RaK v1.5(820): kontrolní SQL pro Fázi 2E-D.
...
-- v820 note: deployment troubleshooting is not part of this SQL.
-- App build resumed from confirmed v814 baseline; DB INSERT/UPDATE policies remain unchanged until mobile RPC smoke is confirmed.

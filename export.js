// v.1.5 (922) – export manifest doplněný o DOM/security hardening docs.
const EXPORT_SOURCE_IDS = {
  ...
  "assets/docs/mobile-performance-smoke-v922.md": "src-mobile-performance-smoke-v922-md",
  "assets/docs/playwright-dom-smoke-draft-v922.md": "src-playwright-dom-smoke-draft-v922-md",
  "assets/docs/due-diligence-closure-v922.md": "src-due-diligence-closure-v922-md",
  "assets/docs/due-diligence-closure-v922.md": "src-due-diligence-closure-v922-md",
  "assets/docs/playwright-smoke-skeleton-v922.md": "src-playwright-smoke-skeleton-v922-md",
  "assets/docs/ttt-ai-hardening-v922.md": "src-ttt-ai-hardening-v922-md",
...
const EXPORT_TEXT_FILES = [
      ...
      'assets/docs/mobile-performance-smoke-v922.md',
      'assets/docs/playwright-dom-smoke-draft-v922.md',
      'assets/docs/due-diligence-closure-v922.md',
      'assets/docs/ttt-ai-hardening-v922.md',
      'assets/docs/playwright-smoke-skeleton-v922.md',
      'assets/docs/due-diligence-closure-v922.md'
];
...
function getRakExportManifest() {
  return {
    ...
    mode: 'export-manifest-preflight-v922',
...
function getRakExportSourceInventoryHealth() {
  ...
  return {
    ...
    mode: 'export-source-inventory-v922',
...
function getRakExportSmokeReport() {
  return Object.assign({}, EXPORT_SMOKE_REPORT, {
    ...
    mode: String(EXPORT_SMOKE_REPORT.mode || 'export-smoke-report-v922'),

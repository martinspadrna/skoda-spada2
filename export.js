// v.1.5 (909) – export manifest doplněný o DOM/security hardening docs.
const EXPORT_SOURCE_IDS = {
  ...
  "assets/docs/dom-security-hardening-plan-v909.md": "src-dom-security-hardening-plan-v909-md",
  "assets/docs/dom-safe-helper-policy-v909.md": "src-dom-safe-helper-policy-v909-md",
  "assets/docs/food-hours-alignment-v909.md": "src-food-hours-alignment-v909-md",
  "assets/docs/games-top-score-dom-hardening-v909.md": "src-games-top-score-dom-hardening-v909-md",
  "assets/docs/games-profile-dom-hardening-v909.md": "src-games-profile-dom-hardening-v909-md",
...
const EXPORT_TEXT_FILES = [
      ...
      'assets/docs/dom-security-hardening-plan-v909.md',
      'assets/docs/dom-safe-helper-policy-v909.md',
      'assets/docs/food-hours-alignment-v909.md',
      'assets/docs/games-top-score-dom-hardening-v909.md',
      'assets/docs/games-profile-dom-hardening-v909.md'
];

function getRakExportManifest() {
  return {
    version: String(window.APP_VERSION || 'v.1.5 (909)'),
    mode: 'export-manifest-preflight-v909',
...
function getRakExportSourceInventoryHealth() {
  ...
  return {
    ...
    mode: 'export-source-inventory-v909',
...
function getRakExportSmokeReport() {
  return Object.assign({}, EXPORT_SMOKE_REPORT, {
    ...
    mode: String(EXPORT_SMOKE_REPORT.mode || 'export-smoke-report-v909'),

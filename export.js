// RaK 1.2 (1.141) – export manifest a release metadata.
...
const RAK_ROTATION_GENERATOR_RULES_CONTRACT_V1116 = Object.freeze({
...
function getRakExportManifest() {
  return {
    version: String(window.APP_VERSION || '1.2 (1.141)'),

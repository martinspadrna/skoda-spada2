...
const CACHE_VERSION = 'v1.5.87';
const SW_APP_VERSION = '1.5';
const STATIC_CACHE = `rotace-static-${CACHE_VERSION}`;
const RUNTIME_CACHE = `rotace-runtime-${CACHE_VERSION}`;
// Core držíme úmyslně malý: login animace step/tap se dotáhnou až při skutečném použití.
const CORE = ['./', './index.html', './manifest.webmanifest', './assets/app-icons/icon-180.png?v=1.5.1', './assets/app-icons/icon-32.png?v=1.5.1', './assets/app-icons/icon-192.png?v=1.5.1', './assets/app-icons/icon-512.png?v=1.5.1', './assets/rak-login-crab.png'];

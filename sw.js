...
const CACHE_VERSION = 'v1.2-dev-20260905-31';
const SW_APP_VERSION = 'development 2026-09-05.31';
const STATIC_CACHE = `rotace-static-${CACHE_VERSION}`;
const RUNTIME_CACHE = `rotace-runtime-${CACHE_VERSION}`;
const CORE = ['./', './index.html', './manifest.webmanifest', './assets/app-icons/icon-180.png', './assets/app-icons/icon-192.png', './assets/app-icons/icon-512.png', './assets/rak-login-crab.png'];

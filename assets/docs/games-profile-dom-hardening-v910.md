# RaK v.1.5 (910) – DOM/security hardening profilů a achievementů

## Cíl

Navazuje na v910, kde se bezpečnostně zpevnil renderer Top score. V909 stejným malým krokem zpevňuje textové výpisy v herních profilech, statistikách a achievementech.

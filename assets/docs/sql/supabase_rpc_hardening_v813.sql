-- RaK v1.5(813): kontrolní SQL beze změny DB, navazuje na hardening v812.
-- Build v813 řeší klientskou opravu přehledu otevírací doby jídelny pro nedělní přesčas.

-- RaK v.1.5 (813) / Fáze 2E-B

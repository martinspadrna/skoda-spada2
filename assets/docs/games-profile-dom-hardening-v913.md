# RaK v.1.5 (913) – DOM/security hardening profilů a achievementů

## Cíl

Navazuje na v913, kde se bezpečnostně zpevnil renderer Top score. V909 stejným malým krokem zpevňuje textové výpisy v herních profilech, statistikách a achievementech.

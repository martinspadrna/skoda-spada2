# RaK v.1.5 (909) – DOM/security hardening profilů a achievementů

## Cíl

Navazuje na v909, kde se bezpečnostně zpevnil renderer Top score. V909 stejným malým krokem zpevňuje textové výpisy v herních profilech, statistikách a achievementech.

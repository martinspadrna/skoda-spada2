...
function createStatsYearOverviewNodes(stats, year) {
  ...
  if (months.length) {
    ...
    // v.1.5 (958): jemné podbarvení je jen v oblasti pod čárou.
...
// v.1.5 (958) – read-only kontrola: měsíční graf obsazenosti má bezpečnou jemnou theme výplň jen pod čárou.

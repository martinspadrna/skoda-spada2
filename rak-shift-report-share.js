...
// RaK DEV – kompaktní mobilní polish Reportu směny. Datová logika a text reportu zůstávají stejné.
(function () {
  'use strict';

  const STYLE_ID = 'rak-shift-report-ui-polish-style-v2';
  let scheduled = false;
...
#rakShiftReport .rakShiftMetaGrid{display:grid;grid-template-columns:minmax(0,1.35fr) minmax(0,1fr);gap:10px}
#rakShiftReport .rakShiftMetaLabel{display:grid;gap:6px;font-size:12px;font-weight:750;opacity:.94}
#rakShiftReport .rakShiftMetaLabel>.rakShiftInput,
#rakShiftReport .rakShiftMetaLabel>.rakShiftSelect{min-height:48px;border-radius:14px;font-size:17px;font-weight:700;background:linear-gradient(180deg,rgba(255,255,255,.075),rgba(255,255,255,.038));border-color:rgba(255,255,255,.14);box-shadow:inset 0 1px 0 rgba(255,255,255,.045)}
#rakShiftReport .rakShiftDate{text-align:center;font-variant-numeric:tabular-nums}
...
#rakShiftReport .rakShiftQty,
#rakShiftReport .rakShiftNok,
#rakShiftReport .rakShiftFree{text-align:center;font-size:16px;font-variant-numeric:tabular-nums}
...
#rakShiftReport .rakShiftProblemRow{display:grid!important;grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;gap:8px!important;align-items:end!important;padding:2px 0 5px}
...
#rakShiftReport .rakShiftProblemText{grid-column:1/-1!important;min-height:46px;font-size:16px}
#rakShiftReport .rakShiftProblemRemove{grid-column:1/-1!important;width:42px!important;height:42px!important;margin:0!important;border-radius:13px!important}
...
#rakShiftReport .rakShiftPreview{padding:14px 15px;border-radius:15px;border-color:rgba(255,255,255,.1);background:linear-gradient(145deg,rgba(4,18,30,.58),rgba(12,23,39,.38));box-shadow:inset 0 1px 0 rgba(255,255,255,.035);font-size:14px;line-height:1.38;white-space:pre-wrap;font-variant-numeric:tabular-nums}
...
@media(max-width:390px){
  #rakShiftReport .rakShiftMetaGrid{grid-template-columns:1fr 1fr;gap:8px}

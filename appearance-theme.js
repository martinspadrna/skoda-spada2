// RaK 1.2 (1.136) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.136) – patternové varianty pro pracovní světlá pozadí.
...
// RaK 1.2 (1.136) – appearance reward contract guard.
...
// RaK 1.2 (1.136) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.136): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.
...
function getRakProfileAppearanceRewardHealth() {
  ...
  return {
    version: window.APP_VERSION || '1.2 (1.136)',

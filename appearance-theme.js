// RaK 1.2 (1.112) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.112) – appearance reward contract guard.
...
// RaK 1.2 (1.112) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.112): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.

// RaK 1.2 (1.143) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.143) – patternové varianty pro pracovní světlá pozadí.
...
// RaK 1.2 (1.143) – appearance reward contract guard.
...
// RaK 1.2 (1.143) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.143): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.
  ...
  // RaK 1.2 (1.143): uložený vzhled profilu nepřepisujeme na default jen proto,
...
const RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1143 = Object.freeze({
  version: '1.2 (1.143)',
...
window.RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1143 = RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1143;

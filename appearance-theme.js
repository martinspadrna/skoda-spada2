...
const RAK_APPEARANCE_DEFS = [
  ...
  { id:'raspberry', label:'Malinový kouř', subtitle:'Malinová, vínová a modrý kouř s růžovým textem', color:'#FF86C8', swatch:'radial-gradient(circle at 17% 18%,#ff427f,transparent 37%),radial-gradient(circle at 84% 18%,#8b3cff,transparent 42%),linear-gradient(145deg,#531833,#3b1d65)', themeVars:{'--bg':'#3b1239','--panel':'rgba(89,26,70,.78)','--panel2':'rgba(74,37,111,.65)','--green':'#FF86C8','--green2':'#FFD2EC','--text':'#FFBEE2','--muted':'#D6B1F7','--soft':'#FFE2F4','--rakThemeAccentStrong':'#FF86C8','--rakThemeAccentSoft':'rgba(255,134,200,.26)','--rakThemeGlow':'rgba(255,68,139,.40)','--rakThemeBorder':'rgba(255,149,207,.42)'}, bgVars:{'--rakBgBase':'#3b1339','--rakAppBackground':'radial-gradient(circle at 9% 12%,rgba(255,58,124,.59),transparent 34%),radial-gradient(circle at 92% 18%,rgba(132,55,255,.52),transparent 40%),radial-gradient(circle at 48% 91%,rgba(74,107,255,.30),transparent 42%),linear-gradient(155deg,#621634,#58216f 51%,#27133d)','--rakAppBackgroundOverlay':'linear-gradient(135deg,rgba(255,255,255,.11),transparent 40%,rgba(31,4,42,.25))','--rakAppBackgroundLite':'linear-gradient(155deg,#74193d,#63277a 53%,#32174d)','--rakBgAccent':'rgba(255,134,200,.36)'} },

// RaK 1.2 (1.141) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.141) – patternové varianty pro pracovní světlá pozadí.
...
// RaK 1.2 (1.141) – appearance reward contract guard.
...
// RaK 1.2 (1.141) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.141): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.
  ...
  // RaK 1.2 (1.141): uložený vzhled profilu nepřepisujeme na default jen proto,
...
const RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1141 = Object.freeze({
  version: '1.2 (1.141)',
...
window.RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1141 = RAK_APPEARANCE_LOCKED_PREFERENCE_PRESERVE_CONTRACT_V1141;

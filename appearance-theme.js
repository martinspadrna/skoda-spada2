// RaK 1.2 (1.154) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.154) – patternové varianty pro pracovní světlá pozadí.
...
// RaK 1.2 (1.154) – appearance reward contract guard.
...
// RaK 1.2 (1.154) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.154): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.
  ...
  // RaK 1.2 (1.154): uložený vzhled profilu nepřepisujeme na default jen proto,

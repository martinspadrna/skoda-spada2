// RaK 1.2 (1.114) – theme, pozadí a profilové UI nastavení.
...
// RaK 1.2 (1.114) – appearance reward contract guard.
...
// RaK 1.2 (1.114) – appearance readability contract guard.
...
function applyProfileUiPreferencesForActiveAccount(options = {}) {
  ...
  let changed = false;
  // RaK 1.2 (1.114): při aktualizaci nesmí prázdné profilové uiSettings shodit uživatelské pozadí zpět na základ.

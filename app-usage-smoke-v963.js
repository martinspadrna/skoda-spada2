#!/usr/bin/env node
// RaK 1.2 (1.113) – smoke test přehledu připojení + Dashboard/appearance contract guard.
const fs = require('fs');
...
function assertReleaseMetadataContractV199() {
  ...
  assertIncludes(exportJs, "displayVersion: '1.2 (1.113)'", 'Release contract v export.js musí držet display verzi 1.105');
  assertIncludes(exportJs, "packageVersion: '1.2.113'", 'Release contract v export.js musí držet package verzi 1.2.113');
  ...
  assertIncludes(changelogMd, `technická verze \`${contract.packageVersion}\``, 'CHANGELOG.md musí uvádět technickou verzi 1.2.113');
...
function assertRotationGeneratorRulesContractV1107() {
  ...
  assertIncludes(ui, "ruleVersion: '1.113'", 'Výsledek generátoru musí vracet aktuální verzi pravidel 1.113');

#!/usr/bin/env node
// RaK 1.2 (1.131) – smoke test přehledu připojení + Dashboard/appearance contract guard.
const fs = require('fs');
...
const releaseMetadataContractV199 = Object.freeze({
  displayVersion: '1.2 (1.131)',
  appLabel: 'RaK 1.2 (1.131)',
  packageVersion: '1.2.131',
  cacheVersion: 'v1.2-1.131',
  realtimeChannel: 'rak-public-live-v1-2-1-126',
  changelogHeader: '## RaK 1.2 (1.131)',
...
function assertReleaseMetadataContractV199() {
  ...
  assertIncludes(exportJs, "displayVersion: '1.2 (1.131)'", 'Release contract v export.js musí držet display verzi 1.105');
  assertIncludes(exportJs, "packageVersion: '1.2.131'", 'Release contract v export.js musí držet package verzi 1.2.114');
...
function assertRotationGeneratorRulesContractV1107() {
  ...
  assertIncludes(ui, "ruleVersion: '1.131'", 'Výsledek generátoru musí vracet aktuální verzi pravidel 1.131');
...
function assertLightPatternThemeContractV1131() {
  ...
  assertIncludes(appearanceThemeJs, 'RAK_LIGHT_PATTERN_BACKGROUND_PATCHES_V1131', 'Pozadí musí mít patch pro světlé patterny v1.131');

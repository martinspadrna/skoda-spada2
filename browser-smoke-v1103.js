#!/usr/bin/env node
// RaK 1.2 (1.133) – browser smoke test přes lokální Chromium/CDP.
...
const EXPECTED_APP_VERSION = '1.2 (1.133)';
...
async function runViewportSmoke(cdpPort, viewport, inlineHtml) {
  ...
  assert(generatorAbsenceRuleState.ruleVersion === '1.133', `${viewport.name}: generátor nemá pravidla 1.133 ${JSON.stringify(generatorAbsenceRuleState)}`);

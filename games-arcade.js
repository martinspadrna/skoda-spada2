(() => {
  ...
  // v.1.5 (958): Denní challenge má vlastní leaderboard pro právě vybranou denní hru.
...
`;
  ...
  function gamesSanitizeLowBestTime(gameId, ms) {
    const n = Number(ms) || 0;
    if (!Number.isFinite(n) || n <= 0) return 0;
    // v.1.5 (958): Pexeso někdy zdědilo chybnou hodnotu 86 400 s z denního/time fallbacku.

// v.1.5 (953) – DOM/action registry audit včetně admin announcement akce a dashboard tickeru.
...
(function setupRakDomActionRegistryAudit() {
  ...
  function updateDomActionSmokeReportFromHealth(health, stage) {
    try {
      ...
      DOM_ACTION_SMOKE_REPORT.version = String(window.APP_VERSION || 'v.1.5 (953)');

...
(function () {
  ...
  function sectionHtml(section) {
    ...
    return [
      ...
      '  <div class="rakShiftSectionHead"><h4>' + section.label + '</h4></div>',
      '  <div class="rakShiftRows">' + first + '</div>',
      '  <button type="button" class="appMenuAction rakShiftAddIndex rakShiftAddBelow" data-shift-add="' + section.id + '">＋ Přidat index</button>',
      '</section>'
    ].join('');
  }
  function problemRow() {
  ...
  function ensureStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:640px){.rakShiftProdRow{grid-template-columns:1fr 1fr 1fr 1fr 30px}.rakShiftProblemRow{grid-template-columns:1fr 1fr 1fr 30px}.rakShiftProblemText{grid-column:1 / -1}.rakShiftProblemRow label span{display:block}.rakShiftSectionHead{align-items:flex-start}}
    `;

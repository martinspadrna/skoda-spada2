// RaK 1.2 (1.115) – zbytkový UI bridge po oddělení modulů.

// RaK 1.2 (1.115) – Více/menu shell je oddělený v app-menu.js.
...
// RaK 1.2 (1.115) – Piškvorky jsou oddělené v games-gomoku.js.
...
// RaK 1.2 (1.115) – Administrace / Rozpisy a Nastavení strojů jsou oddělené v admin-rotation.js.




// RaK 1.2 (1.115) – Administrace / Reporty chyb jsou oddělené v admin-reports.js.

// RaK 1.2 (1.115) – Administrace / Přehled připojení, servis a oznámení jsou oddělené v admin-service-usage.js.


// RaK 1.2 (1.115) – App menu / administrace shell / bug report formulář jsou oddělené v app-menu.js.

// RaK 1.2 (1.115) – showFoodSchedule je v app-navigation.js.
...
// RaK 1.2 (1.115) – showPage, home refresh, externí dlaždice a rotace/kalkulačky zkratky jsou v app-navigation.js.
...
// RaK 1.2 (1.115) – Food/kalendář modaly a vazba dashboard kalendáře jsou v app-navigation.js.


// RaK 1.2 (1.115) – Games hub + account profile jsou oddělené v games-profile.js.

// RaK 1.2 (1.115) – Klasické hry 2048 / Had / Flappy Car jsou oddělené v games-classic.js.
...
// RaK 1.2 (1.115) – Theme, pozadí a profilové UI nastavení jsou oddělené v appearance-theme.js.

function getRakRotaceNamesDockHealth() {
  const result = {
    ok: true,
    version: window.APP_VERSION || '1.2 (1.115)',
...
// RaK 1.2 (1.115) – resize/orientation hlídání aktivního glass indikátoru spodní lišty je v app-navigation.js.

  ...
  const sections = [
    {
      ...
      lines: [
        ...
        'Generátor rozpisu sjednocuje jména bez diakritiky na oficiální podobu, hlídá kritické chyby před uložením, dorovnává měsíční TNKS01/TPKW01 před roční statistikou a umí předvyplnit absence z Google kalendáře; prázdná Historie změn teď vysvětluje starší výpadek ukládání a zálohové tabulky mají pevnější šířky sloupců.'
      ]
    },
    {

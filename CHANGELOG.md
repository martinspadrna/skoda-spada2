...
- Release metadata sjednocená na `RaK 1.2 (1.65)`, technická verze `1.2.65`.
...
- Verze, cache, realtime kanál, service worker, export metadata a GitHub hlavičky sjednocené na `RaK 1.2 (1.65)`.
